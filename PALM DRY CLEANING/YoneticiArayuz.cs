...
namespace PALM_DRY_CLEANING
{
    public partial class YoneticiArayuz : Form
    {
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmdSiparisData = new SqlCommand("insert into SiparisData (Ad,Soyad,TelNo,Mail,Adres,UrunTipi,Kumastipi,Tadilat,Note,SiparisTarihi,TeslimTarihi,Fiyat,Durum,Personel,IslemSaati,Islem) values ('" + txtAd.Text + "','" + txtSoyad.Text + "','" + mtxtTel.Text + "','" + txtMail.Text + "','" + txtAdres.Text + "','" + coboÜrüntipi.SelectedItem + "','" + coboKumaştipi.SelectedItem + "','" + tadilat + "','" + txtNot.Text + "','" + SiparişTarihiString + "','" + dtpTeslimTarihi.Value.ToString("yyyy-MM-dd") + "','" + fiyat + "','" + siparisdurumu + "','" + "admin" + "','" + strTarihSaat + "','" + btnSil.Text + "')", baglanti2);
            cmdSiparisData.ExecuteNonQuery();
            baglanti2.Close();
        ...
        private void btnAra_Click(object sender, EventArgs e)
        {
            listView1.Items.Clear();
            baglanti2.Open();
            SqlCommand komut2 = new SqlCommand("select * from SiparisKayit where Ad like '%"+ txtAranacakKelime.Text+ "%' or Soyad like '%" + txtAranacakKelime.Text + "%'", baglanti2);
            SqlDataReader dr2 = komut2.ExecuteReader();
        ...
        {
            PersonelBilgi personel_bilgi = new PersonelBilgi();
            personel_bilgi.Show();
            this.Hide();
        }
        ...
        {
            SistemKayitlari sistem_kayitlari = new SistemKayitlari();
            sistem_kayitlari.Show();
            this.Hide();
        }
